import { Sum, getForeCast } from './API.js'
...
window.fetchForeCast = async () => {
  ...
  weatherQuery.innerHTML = `
    <div class="wrapper">
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="http://sovhttdl.thaibinh.gov.vn/upload/80611/fck/c23164924ba9e3bcc9affdcaa8b21edf.jpg" alt="profile card">
    </div>

    <div class="profile-card__cnt js-profile-cnt">

      <div class="profile-card__txt">Temperature : ${currentConditions.temp}</div>
      <div class="profile-card__txt">Humidity : ${currentConditions.humidity}</div>
      <div class="profile-card__txt">Wind speed : ${currentConditions.windspeed}</div>
      <div class="profile-card__name">${description}</div>
      <div class="profile-card__txt">Timezone : ${timezone}</div>
      ...
      <div class="profile-card-inf">
        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">${latitude}</div>
          <div class="profile-card-inf__txt">Latitude</div>
        </div>

        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">${longitude}</div>
          <div class="profile-card-inf__txt">Longtitude</div>
        </div>
        <div class="profile-card-inf__item">
            <div class="profile-card-inf__title">${currentConditions.sunrise}</div>
            <div class="profile-card-inf__txt">Sunrise</div>
        </div>
        <div class="profile-card-inf__item">
        <div class="profile-card-inf__title">${currentConditions.sunset}</div>
        <div class="profile-card-inf__txt">Sunset</div>
    </div>
      </div>
...
window.appendChildHeyy = () => {
  const weatherQuery = document.querySelector('#weather')

  let divChild = document.createElement('div')

  divChild.innerText = 'lozzzz'

  weatherQuery.appendChild(divChild)
}
